  ...
  const data=[
    ...
    return (
        <Box sx={{ marginTop: isMobileView ? "100px" : "", backgroundColor: 'black', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <Container sx={{ display: 'flex', flexDirection: isMobileView ? "column" : "row", justifyContent: "space-between", width: '100%',margin:'20px' }}>
            
                <Box sx={{ width:isMobileView?"100%":"100%", display: 'flex', flexDirection: 'column',textAlign:isMobileView?'center':"start"}}>
