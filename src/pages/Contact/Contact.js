...
const Contact = () => {
  ...
  return (
    ...
    <img src="/assets/contactback.webp" style={{ width: '100%',height:'600px', objectFit: 'cover' }}/>
   ...
   <Container sx={{display:'flex',alignItems:'center',justifyContent:'center',width:'100%',flexDirection:'column',marginTop:'20px'}}>
    <Box  sx={{width:'100%',backgroundImage: `url(${"/assets/background.webp"})`, backgroundSize: 'cover',height:'auto',display:'flex',flexDirection:isMobileView?"column":"row",alignItems:'center',justifyContent:'space-evenly',padding:'10px',borderRadius:'20px'}}>
     <img style={{width:'500px',height:isMobileView?"300px":"400px",borderRadius:'20px'}} src="/assets/contact.webp"/>
     <Form/>
